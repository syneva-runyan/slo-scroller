export const levelTracks = [
  ...
  },
  {
    id: 'ai-hallucination',
    label: 'AI Trust',
    description: 'AI reliability depends on shipping grounded answers and rejecting hallucinations before they reach users. Jump to flag a hallucination; let grounded answers pass underneath to ship them.',
    levels: [
      {
        id: 'ai-hallucination-1',
        title: 'Cite Your Sources',
        lesson: 'An AI-trust SLO measures how reliably the system rejects hallucinations and ships grounded answers. At this difficulty most answers are well-sourced and the hallucinations are loud: garbled facts and missing citations. Jump to flag a hallucination, and let grounded answers pass underneath to ship them.',
        objective: 'Reach the finish with 3 or fewer misdispositions (hallucinations shipped or grounded answers suppressed).',
        targetLabel: 'Disposition accuracy at or above 80%. Max 3 misdispositions.',
      ...
      },
      {
        ...
        lesson: 'As models sound more fluent, hallucinations get harder to spot. A tighter AI-trust SLO means the system has less room to ship confident nonsense or to suppress good answers. Stay disciplined: flag only what is unsourced, and ship what is grounded.',
        objective: 'Finish the run with 2 or fewer misdispositions as the hallucinations grow more plausible.',
        targetLabel: 'Disposition accuracy at or above 90%. Max 2 misdispositions.',
      ...
      },
      {
        ...
        lesson: 'At the strictest AI-trust SLO, even confident-sounding outputs need rigorous grounding. One missed hallucination breaks user trust, and one suppressed real answer wastes a correct response. Treat every output as a deliberate disposition decision.',
        objective: 'Close the run with 1 or fewer misdispositions when hallucinations look nearly identical to grounded answers.',
        targetLabel: 'Disposition accuracy at or above 98%. Max 1 misdisposition.',
